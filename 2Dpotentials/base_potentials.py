...
class GeneralPotential:
    ...
    def __init__(self, beta):
        ...
        self.grad_trajectory = None
        self.gauss_trajectory = None
        self.ener_trajectory = None

    def overdamped_trajectory(self, X_0, T=1000, save=1, seed=None, save_grad=False,  save_gauss=False, save_ener=False):
    ...
    @property
    def set_trajectory(self, save_grad,  save_gauss, save_ener):
        """Set and store the MEPs if not already done"""
        if not type(self.trajectory).__module__ == np.__name__:
            if save_grad and not save_gauss and not save_ener:
                self.trajectory, self.grad_trajectory = self.overdamped_trajectory(self.X_0, T=1000, save=1, seed=None,
                                                                                   save_grad=save_grad,
                                                                                   save_gauss=save_gauss,
                                                                                   save_ener=save_ener)
            elif save_gauss and not save_grad and not save_ener:
                self.trajectory, self.gauss_trajectory = self.overdamped_trajectory(self.X_0, T=1000, save=1, seed=None,
                                                                                    save_grad=save_grad,
                                                                                    save_gauss=save_gauss,
                                                                                    save_ener=save_ener)
            elif not save_grad and not save_gauss and save_ener:
                self.trajectory, self.ener_trajectory = self.overdamped_trajectory(self.X_0, T=1000, save=1, seed=None,
                                                                                   save_grad=save_grad,
                                                                                   save_gauss=save_gauss,
                                                                                   save_ener=save_ener)
            elif save_grad and not save_gauss and save_ener:
                self.trajectory, self.grad_trajectory, self.ener_trajectory = self.overdamped_trajectory(self.X_0, T=1000, save=1, seed=None,
                                                                                   save_grad=save_grad,
                                                                                   save_gauss=save_gauss,
                                                                                   save_ener=save_ener)
            elif save_gauss and not save_grad and save_ener:
                self.trajectory, self.gauss_trajectory, self.ener_trajectory = self.overdamped_trajectory(self.X_0,
                                                                                                         T=1000, save=1,
                                                                                                         seed=None,
                                                                                                         save_grad=save_grad,
                                                                                                         save_gauss=save_gauss,
                ...
                self.trajectory, self.grad_trajectory, self.gauss_trajectory = self.overdamped_trajectory(self.X_0,
                                                                                                         T=1000, save=1,
                                                                                                         seed=None,
                                                                                                         save_grad=save_grad,
                                                                                                         save_gauss=save_gauss,
                ...
                self.trajectory = self.overdamped_trajectory(self.X_0,
                                                             T=1000, save=1,
                                                             seed=None,
                                                             save_grad=save_grad,
                                                             save_gauss=save_gauss,
                ...
                self.trajectory, self.grad_trajectory, self.gauss_trajectory, self.ener_trajectory = self.overdamped_trajectory(self.X_0,
                                                                                                         T=1000, save=1,
                                                                                                         seed=None,
                                                                                                         save_grad=save_grad,
                                                                                                         save_gauss=save_gauss,
                                                                                                         save_ener=save_ener)
                return np.array(traj), np.array(grad_traj), np.array(gauss_traj), np.array(ener_traj)
            self.trajectory = self.overdamped_trajectory(self.X_0, T=1000, save=1, seed=None, save_grad=save_grad,  save_gauss=save_gauss, save_ener=save_ener)
