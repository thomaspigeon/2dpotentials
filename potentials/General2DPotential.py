...
class General2DPotential:
    ...
    def __init__(self, minR, R_radius, minP, P_radius, dx, saddle_points, x_domain, y_domain, V_domain, n_bins_x, n_bins_y):
        ...
        :param dx:               step for the gradient descent to compute minimum energy path starting from first order saddle
                          point
        :param saddle_points:    list, len==any, list of np.array with ndim==2, shape==[1,2], list of first order saddle points
